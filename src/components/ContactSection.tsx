...
export const ContactSection: React.FC<ContactSectionProps> = ({
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-background">
      ...
      <div
        className="absolute inset-0 bg-cover bg-center transition-all duration-500 ease-in-out opacity-20 dark:opacity-10"
      ...
      >
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          {Array.from({ length: 15 }).map((_, i) => (
            <div
              key={i}
              className="absolute bg-muted rounded-full animate-bubble opacity-0"
              style={{
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full h-full p-3 sm:p-4 md:p-8 lg:p-12 pb-12 sm:pb-24">
        {/* Main Section - Grid Layout */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 w-full max-w-6xl p-3 sm:p-4 md:p-8 rounded-xl flex-grow mt-6 sm:mt-12">
          {/* Left Side: Title */}
          <div className="flex flex-col justify-end p-4 lg:p-8">
            <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-extrabold text-foreground leading-tight drop-shadow-lg max-w-lg">
              {title}
            </h1>
          </div>
