...
export function ExpandableGallery() {
  ...
  // Responsive offset scaling for stacked photos
  React.useEffect(() => {
    const updateScale = () => {
        ...
        <div className="w-full max-w-6xl mx-auto flex flex-col items-center">
          ...
          <motion.div
            ...
            className={cn(
              "relative w-full",
              isExpanded
                ? "grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-8 px-2 sm:px-4"
          ...
          >
            <div
              className={cn(
                ...
                isExpanded
                  ? "contents"
                  : "h-[260px] sm:h-[350px] md:h-[450px] w-full flex items-center justify-center mb-6 sm:mb-8"
              )}
            >
                ...
                return (
                  <motion.div
                    ...
                    animate={{
                      ...
                      x: !isExpanded ? (photo.x || 0) * scaleFactor : 0,
                      y: !isExpanded ? (photo.y || 0) * scaleFactor : 0,
            ...
            <AnimatePresence>
              {!isExpanded && (
                <motion.div
                  ...
                  initial={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="text-center max-w-2xl space-y-8 mt-12"
                >
                  <h2 className="text-xl sm:text-2xl md:text-4xl font-normal tracking-tight text-foreground/90 leading-tight">
